...
Run the distribution (created in `build/install/prl-wa-task-configuration` directory)
...
(set to `4090` in this template app).
...
## Testing locally
./gradlew test --tests CamundaTaskInitiationTest
